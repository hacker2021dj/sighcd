<div class="container p-0 m-0">
    ...
    <div class="mb-3 row">
        <label class="col-md-3 col-form-label requerido">índice</label>
        <div class="col-md-2">
        ...
        <div class="col-md-4">
            <input class="form-control" type="text" name="icono" id="icono" value="{{old('icono', $menu->icono ?? '')}}" maxlength="20">
